...
- Play デベロッパーアカウントの「テスター 12 名以上」要件は 2026 年時点で正しいか公式で再確認
- LINE Messaging API の Push 月間上限: **コミュニケーションプラン（フリープラン）= 月 200 通で確定**（2026-05 LYコーポレーション公開情報で確認済）
- AdSense の表現を公式断定ではなく「肌感覚」「審査を通りやすい」のトーンダウン版に修正済（2026-05-08 反映）

### ユーザー追記推奨箇所

- 「Android で 8 割実装済み」の具体的な機能リスト
- ピボット時の心理（一次情報差し込み）
- 想定 PV と AdSense の数字感（後追いで）

### 引用元

- `vaccine-note-line-docs/RESUME.md`（プロジェクト概要・確定方針）
- `vaccine-note-line-docs/MARKETING.md`（後追いで参照）
- 想定文字数: 2,500〜3,000 字 → 本文約 2,700 字
